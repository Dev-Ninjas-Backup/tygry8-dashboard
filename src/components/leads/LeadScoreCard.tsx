    ...
    <div className="space-y-6">
      ...
      <div className="p-6 md:p-8 bg-[#0f2347] text-white rounded-3xl border border-[#1e3a6a] shadow-lg space-y-6">
        ...
        <div className="pt-4 border-t border-white/10 space-y-1.5">
          <span className="text-[11px] font-bold text-slate-300/70 uppercase tracking-wider block">
            Priority Level
          </span>
          <span className="inline-block px-3 py-1 bg-amber-500 text-amber-950 font-black text-[10px] tracking-widest rounded-md uppercase">
            {valuation.priority}
          </span>
        </div>
